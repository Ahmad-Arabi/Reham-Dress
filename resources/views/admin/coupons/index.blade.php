    ...
    <div class="py-4">
            ...
            <div class="mb-4">
                ...
                <div>
                    <a href="{{ route('admin.coupons.create') }}" class="btn btn-primary  mt-3">
                        <svg class="me-2" style="width: 1.25rem; height: 1.25rem;" xmlns="http://www.w3.org/2000/svg"
        ...
        @if (session('success'))
            <div class="alert alert-success alert-dismissible fade show mb-4 border-2 border-success shadow-sm"
                role="alert" style="background:#f0fdf4; color:#166534; font-weight:600;">
                {{ session('success') }}
        ...
        <div class="small mt-1">
            ...
            <div class="filters-row mb-3">
                <input type="text" id="searchInput" name="search" data-filter="search" placeholder="بحث عن كوبون..."
                    class="form-control search-filter-input" style="max-width: 220px;" value="{{ request('search', '') }}">
                <div class="position-relative" style="max-width: 180px; display:inline-block;">
                    <select id="statusFilter" name="status" data-filter="status"
                        class="form-select search-filter-input pe-5">
                        ...
                        <tbody>
                            @foreach ($coupons as $coupon)
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="badge @if ($coupon->isFeatured === 1) bg-success text-success-emphasis @else bg-danger text-danger-emphasis @endif">
