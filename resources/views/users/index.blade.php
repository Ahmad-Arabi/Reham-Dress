...
<div class="py-4">
    <div class="container-fluid">
        ...
        <div class="filters-row mb-3 d-flex gap-2">
            <input type="text" id="searchInput" name="search" data-filter="search" placeholder="بحث عن مستخدم..." class="form-control" style="max-width: 220px;" value="{{ request('search', '') }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-2 justify-content-end">
                                    ...
                                    <form action="{{ route('users.delete', $user->id) }}" method="POST" onsubmit="return confirm('هل أنت متأكد من حذف هذا المستخدم؟');">
                                        @csrf
                                        @method('DELETE')
